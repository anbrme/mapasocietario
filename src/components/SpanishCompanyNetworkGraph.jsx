...
const SEARCH_COPY = {
  en: {
    ...
    privateNoteHelp: 'This is your annotation, not BORME or Registro Mercantil data. It stays with the graph and is included in exported graph snapshots and situation reports. Review it before sharing either file.',
  ...
  es: {
    ...
    privateNoteHelp: 'Esta es tu anotación, no un dato del BORME ni del Registro Mercantil. Se conserva con el grafo y se incluye en las instantáneas exportadas y los informes de situación. Revísala antes de compartir cualquiera de los archivos.',
