export const DATA_MAINTENANCE = Object.freeze({
  enabled: false,
  title: 'Index fix in progress to target certain limited cases (28 companies out of > 3.1 million) where officers appeared resigned when they are actually active. It should be fast.',
  message:
