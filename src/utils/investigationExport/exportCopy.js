...
const ES = {
  ...
  facts: {
    ...
    steps: n => (n === 1 ? 'paso' : 'pasos'),
    notes: n => (n === 1 ? 'nota' : 'notas'),
    registry: 'registro leído',
  },
  ...
  legendActive: 'Cargo vigente',
  legendCeased: 'Cargo cesado',
  legendFlag: 'Señalado',
...
const EN = {
  ...
  facts: {
    ...
    steps: n => (n === 1 ? 'step' : 'steps'),
    notes: n => (n === 1 ? 'note' : 'notes'),
  ...
  legendActive: 'Active seat',
  legendCeased: 'Ceased seat',
  legendFlag: 'Flagged',
