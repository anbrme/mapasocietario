 ...
 * 2026-06-02; v3Names re-verified 2026-07-09 after enrichment re-canonicalized
 * five doc names. Page lookups key on `hoja` (group_key); v3Name is fallback.
 * `note` flags entities that need ongoing attention.
 */
...
export const SEED = {
  ...
  'amadeus-it-group':             { name: 'Amadeus IT Group', v3Name: 'AMADEUS IT GROUP SA', nif: 'A-84236934', isin: 'ES0109067019', ticker: 'BME:AMS', sector: 'Turismo', website: 'https://amadeus.com/', hoja: 'M 371900', lei: '9598004A3FTY3TEHHN09' },
  ...
  'bbva':                         { name: 'BBVA', v3Name: 'BANCO BILBAO VIZCAYA ARGENTARIA SA', nif: 'A48265169', isin: 'ES0113211835', ticker: 'BME:BBVA', sector: 'Banca', website: 'https://www.bbva.com/', hoja: 'BI 17', lei: 'K8MS7FD7N5Z2WQ51AZ71' },
  'bankinter':                    { name: 'Bankinter', v3Name: 'BANKINTER SA', nif: 'A28157360', isin: 'ES0113679I37', ticker: 'BME:BKT', sector: 'Banca', website: 'https://www.bankinter.com/', hoja: 'M 7766', lei: 'VWMYAEQSTOPNV0SUGU82' },
  ...
  'grifols':                      { name: 'Grifols', v3Name: 'GRIFOLS SA', nif: 'A58389123', isin: 'ES0171996087', ticker: 'BME:GRF', sector: 'Farmacéutica', website: 'https://www.grifols.com/', hoja: 'B 92799', lei: '959800HSSNXWRKBK4N60' },
  ...
  'iberdrola':                    { name: 'Iberdrola', v3Name: 'IBERDROLA SA', nif: 'A-48010615', isin: 'ES0144580Y14', ticker: 'BME:IBE', sector: 'Energía', website: 'https://www.iberdrola.com/', hoja: 'BI 167', lei: '5QK37QC7NWOJ8D7WVQ45' },
  ...
  'inditex':                      { name: 'Inditex', v3Name: 'INDUSTRIA DE DISEÑO TEXTIL, S.A.', nif: 'A-15075062', isin: 'ES0148396007', ticker: 'BME:ITX', sector: 'Textil', website: 'https://www.inditex.com/', hoja: 'C 3342', lei: '549300TTCXZOGZM2EY83' },
  ...
  'mapfre':                       { name: 'Mapfre', v3Name: 'MAPFRE SA', nif: 'A08055741', isin: 'ES0124244E34', ticker: 'BME:MAP', sector: 'Seguros', website: 'https://www.mapfre.com/', hoja: 'M 6152', lei: '95980020140005693107' },
  ...
  'banco-santander':              { name: 'Banco Santander', v3Name: 'BANCO SANTANDER, SA', nif: 'A-39000013', isin: 'ES0113900J37', ticker: 'BME:SAN', sector: 'Banca', website: 'https://www.santander.com/', hoja: 'S 1960', lei: '5493006QMFDDMYWIAM13' },
