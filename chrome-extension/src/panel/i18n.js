const STRINGS = {
  en: {
    ...
    officersAtDissolution: 'Officers at dissolution',
    dissolvedSeatsNote: 'These positions ended with the company and are not current.',
    lastFiling: 'last filing', nowNamed: 'now',
    ...
    evtFirstSeen: 'First seen in BORME',
    evtRenamed: 'Renamed',
    evtAddress: 'Address',
    evtCapital: 'Capital',
  ...
  es: {
    ...
    officersAtDissolution: 'Cargos al disolverse',
    dissolvedSeatsNote: 'Estos cargos terminaron con la empresa; no son actuales.',
    lastFiling: 'último asiento', nowNamed: 'ahora',
    ...
    evtFirstSeen: 'Primera aparición en BORME',
