...
const T = {
  es: {
    ...
    disclaimer: 'Información no oficial elaborada a partir de datos del BORME mediante procesos automatizados. Puede contener errores u omisiones. Mapa Societario no es un registro oficial.',
  ...
  en: {
    ...
    disclaimer: 'Unofficial information built from BORME data through automated processes. It may contain errors or omissions. Mapa Societario is not an official registry.',
