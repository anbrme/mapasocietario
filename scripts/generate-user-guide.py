...
COPY = {
    "en": {
        ...
        "steps": [
            ...
            ("ANALYZE", "Filter, use Shared connections and Pathfinder. In a node's preview, Replay history plays its network forming act by act."),
            ("SAVE OR ACT", "Annotate, select the entities of your story, open the situation report, save a snapshot, monitor companies or order due diligence."),
        ],
        "desktop": "DESKTOP GRAPH",
        "desktop_items": [
            ("Double-click", "Expand a company or officer. Cmd/Ctrl+click selects it for the report's walkthrough."),
        ...
        "output_cards": [
            ("SITUATION REPORT", "FREE | 1+ companies", "Your selected entities become a guided walkthrough, in your order, with your notes and the registry evidence under each. Play it on the map, then download HTML or copy for Word."),
            ...
            ("AI INVESTIGATION", "UP TO 10 SELECTED ENTITIES", "Investigate the same selected entities with the current network as context."),
        ],
    ...
    "es": {
        ...
        "updated": "Actualizada el 18 de septiembre de 2026",
        ...
        "steps": [
            ...
            ("ANALIZA", "Filtra, usa Conexiones compartidas y Pathfinder. En la vista previa, Reproducir historia muestra la red formándose acto a acto."),
            ("GUARDA O ACTÚA", "Anota, selecciona las entidades de tu historia, abre el informe de situación, guarda una instantánea, monitoriza empresas o pide due diligence."),
        ],
        "desktop": "GRAFO EN ESCRITORIO",
        "desktop_items": [
            ("Doble clic", "Amplía una empresa o un cargo. Cmd/Ctrl+clic lo selecciona para el recorrido del informe."),
        ...
        "output_cards": [
            ("INFORME DE SITUACIÓN", "GRATIS | 1+ empresas", "Las entidades que seleccionas forman un recorrido guiado, en tu orden, con tus notas y la evidencia registral bajo cada una. Reprodúcelo en el mapa y descarga el HTML o cópialo para Word."),
            ...
            ("INVESTIGACIÓN POR IA", "HASTA 10 ENTIDADES", "Investiga las mismas entidades seleccionadas con la red actual como contexto."),
        ],
